  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Esgotamento e higienização de fossas séticas com camião de auto vácuo. Descarte ecológico certificado e atendimento rápido.",
      );
    } else {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl md:text-3xl font-extrabold text-accent-foreground">
              Fossa entupida ou transbordando?
            </h2>
