  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Desentupimento rápido e sem quebra-quebra no Morumbi e SP. Pias, ralos e esgotos.",
      );
    } else {
    ...
    () => [
      {
        ...
        answer:
          "Na imensa maioria dos casos, não! A nossa tecnologia de cabos em espiral entra na tubulação e tritura a obstrução (cabelos, gordura, plásticos) restaurando o fluxo sem danificar a estrutura da sua casa.",
      },
      {
        question: "Qual o tempo de chegada para uma emergência?",
        answer:
          "Temos unidades móveis espalhadas estrategicamente pela zona sul e Morumbi, garantindo a chegada da equipa técnica em até 30 minutos após a sua chamada.",
      },
      {
        question: "Cobram a visita técnica para avaliar o entupimento?",
        answer:
          "A visita técnica é 100% gratuita. O técnico avalia o local, identifica o problema e passa o orçamento sem qualquer compromisso.",
      },
    ],
    [],
  );
      ...
      "@graph": [
        {
          ...
          description:
            "Desentupimento profissional de pias, ralos, vasos sanitários e tubulações em geral. Atendimento 24h com equipamentos modernos e sem quebra-quebra.",
        },
        {
          "@type": "FAQPage",
          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <h2 className="text-xl sm:text-2xl text-muted-foreground font-medium mb-8 leading-relaxed">
                Pia, ralo ou vaso entupido? Resolvemos agora com equipamentos
                modernos e{" "}
                <strong className="text-foreground">sem quebra-quebra.</strong>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <h2 className="text-3xl lg:text-4xl text-foreground mb-6">
              A Solução para o{" "}
              <strong className="text-accent">Entupimento</strong>
            </h2>
            <p className="text-muted-foreground">
              Não tente usar produtos químicos agressivos que derretem o
              encanamento. A nossa equipa de{" "}
              <strong>desentupimento profissional</strong> resolve problemas em
              pias, ralos de banheiro, vasos sanitários e tubulações principais
              de forma mecânica e segura.
            </p>
            <h3 className="text-2xl text-foreground mt-8 mb-4">
              Tecnologia Rotativa
            </h3>
            <p className="text-muted-foreground">
              Utilizamos máquinas <strong>K-50 e K-500</strong> com cabos em
              espiral que trituram a obstrução (cabelos, gordura, plásticos)
              restaurando o fluxo sem danificar a estrutura da sua casa.
            </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 text-muted-foreground">
                    ...
                    <p className="text-sm font-medium">
                      Equipamentos rotativos de ponta.
                    </p>
                  </div>
                  <div className="flex items-center gap-4 text-muted-foreground">
                    <ShieldCheck className="w-5 h-5 text-accent" />
                    <p className="text-sm font-medium">
                      Garantia total do serviço prestado.
                    </p>
                  </div>
                  <div className="flex items-center gap-4 text-muted-foreground">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-display font-extrabold text-3xl md:text-4xl text-foreground">
              Dúvidas sobre o <span className="text-accent">Serviço</span>
            </h2>
          </div>
