  ...
  const faqs = useMemo(() => [
    {
      ...
      answer: 'O hidrojateamento é uma técnica que utiliza água em altíssima pressão para limpar e desobstruir tubulações. É a solução mais eficaz para remover gordura petrificada, cimento, raízes e resíduos industriais sem danificar os canos.'
    },
    {
      question: 'O hidrojateamento pode danificar os meus canos?',
      answer: 'Não. Os nossos técnicos regulam a pressão da água de acordo com o diâmetro e o material da tubulação, garantindo uma limpeza profunda a 100% sem qualquer risco de rutura estrutural.'
    },
    {
      question: 'Fazem hidrojateamento preventivo em condomínios?',
      answer: 'Sim, oferecemos contratos de manutenção preventiva para condomínios e empresas no Morumbi, realizando o hidrojateamento de prumadas e colunas para evitar entupimentos futuros.'
    }
  ], []);
    ...
    "@graph": [
      {
        ...
        "description": "Limpeza profunda de tubulações com hidrojateamento de alta pressão. Remoção de incrustações em indústrias, condomínios e residências."
      },
      {
        "@type": "FAQPage",
    ...
    <main className="bg-background min-h-screen">
          ...
          <div className="max-w-3xl">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 mb-6 backdrop-blur-sm">
                ...
                <span className="text-xs font-bold text-accent tracking-wider uppercase">Alta Pressão - Residencial e Industrial</span>
              </div>
              ...
              <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold text-foreground leading-tight tracking-tight mb-6">
                Hidrojateamento no <span className="text-accent">Morumbi e Grande SP</span>
              </h1>
      ...
      <section className="bg-accent py-8 border-y border-accent/20 shadow-inner">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl md:text-3xl font-extrabold text-accent-foreground">Tubulações pesadas entupidas?</h2>
            <p className="text-accent-foreground/80 font-medium mt-1">A força da água resolve o que as máquinas comuns não conseguem.</p>
          </div>
      ...
      <section className="py-20 lg:py-32 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-start">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="prose prose-lg dark:prose-invert prose-headings:font-display prose-headings:font-bold prose-a:text-accent max-w-none">
            <h2 className="text-3xl lg:text-4xl text-foreground mb-6">A Potência do <strong className="text-accent">Hidrojateamento</strong></h2>
            <p className="text-muted-foreground">O <strong>hidrojateamento</strong> é a solução de ponta para entupimentos severos. Como especialista no <strong>Morumbi e Grande São Paulo</strong>, a Protec utiliza camiões equipados com bombas de alta e ultra pressão que disparam jatos de água capazes de cortar raízes e pulverizar cimento no interior dos canos.</p>
            <h3 className="text-2xl text-foreground mt-8 mb-4">Manutenção de Condomínios e Indústrias</h3>
            <p className="text-muted-foreground">Trabalhamos com redes de águas pluviais, galerias de esgoto, caixas de gordura industriais e colunas de prédios. A limpeza com <strong>alta pressão</strong> restaura o diâmetro original da tubulação, prevenindo inundações e paralisações operacionais.</p>
            ...
            <div className="rounded-3xl overflow-hidden shadow-2xl border border-border bg-card">
              ...
              <div className="p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 text-muted-foreground"><MapPin className="w-5 h-5 text-accent" /><p className="text-sm font-medium">Equipas prontas em SP e Interior.</p></div>
                  <div className="flex items-center gap-4 text-muted-foreground"><Wrench className="w-5 h-5 text-accent" /><p className="text-sm font-medium">Ajuste milimétrico de pressão de água.</p></div>
                  <div className="flex items-center gap-4 text-muted-foreground"><ShieldCheck className="w-5 h-5 text-accent" /><p className="text-sm font-medium">Laudo técnico após conclusão.</p></div>
                </div>
                <a href="https://wa.me/5511940103334" target="_blank" rel="noopener noreferrer" className="block mt-8">
                  <Button className="w-full h-12 text-base font-bold bg-green-500 hover:bg-green-600 text-white">Solicitar Orçamento Grátis</Button>
                </a>
              </div>
            </div>
          </motion.div>
      ...
      <section className="py-20 bg-secondary/30 border-t border-border">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12"><h2 className="font-display font-extrabold text-3xl md:text-4xl text-foreground">Perguntas Frequentes sobre <br/> <span className="text-accent">Hidrojateamento</span></h2></div>
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <motion.div key={index} initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: index * 0.1 }} className="bg-card border border-border rounded-2xl p-6 shadow-sm">
