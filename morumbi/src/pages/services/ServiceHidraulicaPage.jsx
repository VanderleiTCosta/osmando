  ...
  const faqs = useMemo(() => [
    {
      ...
      answer: 'Sim! Fazemos a substituição do reparo (carrapeta/borracha) ou a troca completa do registo ou torneira, estancando o vazamento e reduzindo a sua conta de água.'
    },
    {
      question: 'Fazem instalação de louças e metais novos?',
      answer: 'Com certeza. Instalamos pias, vasos sanitários, misturadores, chuveiros e bidés com acabamento impecável, seguindo todas as normas de segurança.'
    },
    {
      question: 'E se um cano estourar de madrugada?',
      answer: 'A nossa equipa de plantão 24 horas está pronta para fechar o abastecimento e reparar o cano estourado de imediato, minimizando os danos causados pela água no seu imóvel.'
    }
  ], []);
