  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Inspeção detalhada de tubulações com câmara de alta resolução. Diagnóstico exato de entupimentos sem necessidade de quebrar paredes ou pisos.",
      );
    } else {
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 mb-6 backdrop-blur-sm">
                ...
                <span className="text-xs font-bold text-accent tracking-wider uppercase">
                  Diagnóstico por Imagem - Tecnologia 4K
                </span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl md:text-3xl font-extrabold text-accent-foreground">
              Não sabe onde está o problema?
            </h2>
            <p className="text-accent-foreground/80 font-medium mt-1">
              Encontramos com precisão cirúrgica.
            </p>
          </div>
          <a
      ...
      <section className="py-20 lg:py-32 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <p className="text-muted-foreground">
              O <strong>laudo técnico</strong> gerado após a inspeção é aceito
              por seguradoras e administradoras de condomínios, servindo como
              prova para acionamento de garantias e coberturas.
            </p>
