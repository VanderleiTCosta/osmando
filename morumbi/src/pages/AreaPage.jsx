...
const TESTIMONIALS = [
  {
    name: "Helena Cecília",
    text: "Chegaram muito rápido e resolveram meu problema de verdade. Recomendo!",
  },
  {
    name: "João Antonio",
    text: "Cobraram muito mais barato do que imaginava e resolveram tudo rapidamente.",
  },
  {
    name: "Laura Alice",
    text: "Atendimento ótimo e meus problemas foram solucionados. Empresa profissional!",
  },
];
...
export default function AreaPage() {
  ...
  const nearbyAreas = dynamicPagesData
    .filter(
      (p) =>
        p.region === pageData.region &&
        p.serviceName === pageData.serviceName &&
        p.slug !== slug,
    )
    .slice(0, 6);
              ...
              >
                <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 mb-6">
                  ...
                  <span className="text-xs font-medium text-primary">
                    Equipe em {pageData.neighborhood}
                  </span>
                </div>
                ...
                <p className="mt-6 text-lg text-muted-foreground max-w-lg leading-relaxed">
                  ...
                  <strong className="text-foreground">
                    {pageData.serviceName.toLowerCase()} em{" "}
                  </strong>
                  <strong className="text-foreground">
                    {pageData.neighborhood}
                  </strong>{" "}
                  com visita gratuita e chegada em até{" "}
                  <strong className="text-foreground">30 minutos</strong>. Grupo
                  Protec — mais de 15 anos de experiência.
                </p>

                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                  <a
                    href={`https://wa.me/5511937724242?text=Olá! Preciso de orçamento para ${pageData.serviceName} em ${pageData.neighborhood}.`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button
                      size="lg"
                      className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-base px-8 h-14 w-full sm:w-auto"
                    >
                      Chamar no WhatsApp
                  ...
                  <a href="tel:08005919537">
                    <Button
                      size="lg"
                      variant="outline"
                      className="border-border text-foreground font-semibold text-base px-8 h-14 w-full sm:w-auto hover:bg-secondary"
                    >
                ...
                <div className="bg-card border border-border rounded-2xl p-8 shadow-2xl">
                  <div className="text-center mb-6">
                    <h2 className="font-display font-bold text-xl text-foreground">
                      Orçamento em {pageData.neighborhood}
                    </h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
              {SERVICES.map((service, i) => (
                <motion.a
                  key={service}
                  href={`https://wa.me/5511937724242?text=Olá! Preciso de ${service} em ${pageData.neighborhood}.`}
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h2 className="font-display font-extrabold text-3xl text-foreground mb-6">
                {pageData.serviceName} de confiança em{" "}
                <span className="text-accent">{pageData.neighborhood}</span>
              </h2>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
                Não espere o problema piorar. Ligue ou chame no WhatsApp e
                receba atendimento imediato com visita gratuita.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
                <a
                  href={`https://wa.me/5511937724242?text=Olá! Preciso de ${pageData.serviceName} em ${pageData.neighborhood}.`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Button
                    size="lg"
                    className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-base px-8 h-14"
                  >
                    Chamar no WhatsApp
                    <ArrowRight className="w-5 h-5 ml-2" />
                  </Button>
                ...
                <a href="tel:08005919537">
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-border text-foreground font-semibold text-base px-8 h-14 hover:bg-secondary"
                  >
                    0800 591 9537
                  </Button>
                </a>
