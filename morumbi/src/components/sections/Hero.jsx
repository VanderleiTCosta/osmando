        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-lg leading-relaxed">
              Solução imediata para entupimentos. Visita gratuita, orçamento sem
              compromisso e chegamos em até{" "}
              <strong className="text-foreground">30 minutos</strong>. Mais de
