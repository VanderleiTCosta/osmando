      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-foreground">
            Precisa de uma{" "}
            <span className="text-accent">desentupidora agora</span>?
          </h2>
          <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
            Não espere o problema piorar. Ligue agora ou chame no WhatsApp e
            receba atendimento imediato com visita gratuita e orçamento sem
            compromisso.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
            <a
              href="https://wa.me/5511937724242?text=Olá! Preciso de um orçamento urgente para desentupimento."
              target="_blank"
